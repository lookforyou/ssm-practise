...
<body>
    <div class="header">
        ...
        <ul class="inline">
            <li>
                <img src="${pageContext.request.contextPath}/images/32/client.png" />&nbsp;&nbsp;欢迎您,${user.username}
            </li>
            <li class="dropdown">
    ...
    <div class="container-fluid content">
        <div class="row-fluid">
            ...
            <div class="span10 content-right">
                <iframe src="${pageContext.request.contextPath}/cust/findAll" class="iframe"></iframe>
            </div>
        </div>
    </div>
